...
class AllQuestionsViewController: UIViewController {
    ...
    lazy var user1 = User(id: "123", name: "Aaron Lin", email: "aaronlin851117@gmail.com", avatar: self.avatar1)
    lazy var user2 = User(id: "123", name: "Eric Tsai", email: "ts.eric@gmail.com", avatar: self.avatar2)
